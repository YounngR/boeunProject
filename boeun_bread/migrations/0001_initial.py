# Generated by Django 2.2.7 on 2020-03-05 06:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_status', models.CharField(choices=[('1', '상품준비중'), ('2', '배송중'), ('3', '배송완료')], default='1', max_length=1)),
                ('order', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='boeun_bread.Order')),
            ],
        ),
        migrations.CreateModel(
            name='Cart_Product',
